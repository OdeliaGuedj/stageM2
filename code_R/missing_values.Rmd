...
Permet de virer les sujets (identifiés par id, var devant être présente dans la base dt) ayant au moins uneNA dans au moins une des variables de list_var.
...
#export2latex(export_table23, file = "table223.tex")
```
...
#export2latex(export_table43, file = "table223.tex")
```
