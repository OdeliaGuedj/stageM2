...
plot des du log(-log(S(t))) pout la variable binaire (présence de plaques).
...
for(var in test_univar_deces){
  if(is.numeric(data2[,var])){
    ...
    tmp_tab = verifHyp_loglin_coxUnivar(var,"time_to_deces","deces",data2,nb.class = 6)
  ...
  table_verif = rbind(table_verif,tab)
}
rm(var)
```
