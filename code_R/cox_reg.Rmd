...
f_test = formula(paste("Surv(time, evt)~", generate_str_var(parm_temp), "+",generate_str_var(var_ajust_tmp)))
cox = coxph(f_test, data2)
cox
```
```{r}
...
var_et_deces_m4 = c("pr_sence_de_plaque_s____l__cho", "young", "pwvloc", "diam_tre_en_bm__mm_")
var_et_chd_m4 = c("pr_sence_de_plaque_s____l__cho", "imt___m_", "dploc")
```
