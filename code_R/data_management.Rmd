...
data$mbp = as.numeric((data$pas+ 2*data$pad)/3) # mean blood pressure
```

```{r}
data$pa_cat = NA
data$pa_cat[data$pas < 120 & data$pad < 80] = "Normal"
data$pa_cat[data$pas < 129 & data$pas > 120 & data$pad < 80] = "Elevée"
data$pa_cat[(data$pas < 139 & data$pas > 130) | (data$pad < 89 & data$pad > 80)] = "HP Stage 1"
data$pa_cat[data$pas >= 140 | data$pad >= 90] = "HP Stage 2"
data$pa_cat[data$pas >= 180 | data$pad > 120] = "HP Crisis"
```
```{r}
