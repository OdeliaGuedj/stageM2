...
data3_std = data2_std[complete.cases(data2_std[,var_ajust]),]
```
...
data4_std = data2_std[complete.cases(data2_std[,echotracking_clean]),]
```
...
data5_std = data2_std[complete.cases(data2_std[,c(var_ajust,echotracking_clean)]),]
```
