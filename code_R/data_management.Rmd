...
```{r}
data$HTA_cat = NA
data$HTA_cat[data$pas < 120 & data$pad < 80] = "Normal"
data$HTA_cat[data$pas < 130 & data$pas >= 120 & data$pad < 80] = "Elevée"
data$HTA_cat[(data$pas < 140 & data$pas >= 130) | (data$pad < 90 & data$pad >= 80)] = "HP Stage 1"
data$HTA_cat[data$pas >= 140 | data$pad >= 90] = "HP Stage 2"
data$HTA_cat[data$pas >= 180 | data$pad >= 120] = "HP Crisis"
```
```{r}
